...
runSimpleQuery = assertEqual ""
  "Andrew | 35\nTom | 36\n"
  (runQuery (Q.Query (Q.Select ["first_name", "age"]) (Q.From "ages") (Q.Where (Gt (Var "age") (LitI 33)))) (BLU.fromString "first_name, last_name, age\nAndrew, McKnight, 35\nTom, Ash, 36\nCayley, Carlson, 31\nJuly, McKnight, 0\n"))

runSimpleQueryReversed :: Assertion
runSimpleQueryReversed = assertEqual ""
  "35 | Andrew\n36 | Tom\n"
  (runQuery (Q.Query (Q.Select ["age", "first_name"]) (Q.From "ages") (Q.Where (Gt (Var "age") (LitI 33)))) (BLU.fromString "first_name, last_name, age\nAndrew, McKnight, 35\nTom, Ash, 36\nCayley, Carlson, 31\nJuly, McKnight, 0\n"))

runUppercaseQuery :: Assertion
runUppercaseQuery = assertEqual ""
  "Andrew | 35\nTom | 36\n"
  (runQuery (Q.Query (Q.Select ["FirstName", "Age"]) (Q.From "ages") (Q.Where (Gt (Var "Age") (LitI 33)))) (BLU.fromString "FirstName, LastName, Age\nAndrew, McKnight, 35\nTom, Ash, 36\nCayley, Carlson, 31\nJuly, McKnight, 0\n"))
